def collect():
    result = {
        ...
        'manufacturer': 'GigabyteTechnologyCo.,Ltd.',
        'model': 'P67X-UD3R-B3',
        'wake_up_type': 6,
        ...
        'nic': [
            {
                ...
                'model': '[00000011]RealtekRTL8192CUWirelessLAN802.11nUSB2.0NetworkAdapter',
                'name': 11,
            ...
            },
            {
                ...
                'model': '[00000013]VirtualBoxHost-OnlyEthernetAdapter',
                'name': 13,
            ...
            {
                'mac': '24: CF: 92: FF: 48: 34',
                'model': '[00000017]MicrosoftVirtualWiFiMiniportAdapter',
                'name': 17,
                'ip_address': '',
                'net_mask': ''
            },
            {
                ...
                'model': '[00000018]Bluetooth设备(个人区域网)',
                'name': 18,
                'ip_address': '',
                'net_mask': ''
            }
